...
assert.equal(fileToText.release.version, "2.1.0");
assert.equal(fileToText.release.channel, "beta");
assert.equal(fileToText.release.download_available, true);
assert.equal(fileToText.release.assets.length, 1);
assert.equal(fileToText.release.assets[0].name, "L-1.File.To.Text.Setup.v2.1.0.exe");
assert.equal(fileToText.release.assets[0].size, 146969357);
assert.equal(fileToText.release.assets[0].sha256, "b4cb233299b9660eac81f702a7215da13401aefb79d6591eb651c3f47cda3406");
assert.equal(fileToText.release.assets[0].url, "https://github.com/L-One-Tools/l-one-tools-releases/releases/download/l-1-file-to-text-v2.1.0-public-beta/L-1.File.To.Text.Setup.v2.1.0.exe");
